				...
				<ul class="pcoded-item pcoded-left-item" item-border="true"
					...
					<a href="javascript:void(0)" class="waves-effect waves-dark"> <span class="pcoded-micon">
						...
						<ul class="pcoded-submenu">
							<li class=" "><a href="studentlistexams"
								class="waves-effect waves-dark"> <span class="pcoded-mtext">List Exam</span>
							</a></li>
							<li class=" "><a href="resultlist"
								class="waves-effect waves-dark"> <span class="pcoded-mtext">Exam Result List</span>
							</a></li>
