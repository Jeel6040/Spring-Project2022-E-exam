                                    ...
                                    <tbody>
                                         <c:forEach items="${course }" var="c">
	                                      <tr>
		                                      ...
		                                      <td>
		                                      	<a href="editcourse?courseId=${c.courseId}" style="color:black;" >
...
<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  ...
  <form method="post" action="savecourse">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <span id="form_message"></span>
		          	...
		          	<div class="form-group">
		          		...
		          		<input type="text" name="courseName" id="courseName" class="form-control" required data-parsley-pattern="/^[a-zA-Z0-9 \s]+$/" data-parsley-trigger="keyup" />
		          	</div>
		          	<div>
      ...
      <div class="modal-footer">
        <input type="submit" name="submit" id="submit_button" class="btn btn-success" value="Add Course" />
