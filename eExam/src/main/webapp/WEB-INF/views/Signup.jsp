          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <div class="form-group">
                    ...
                    <input type="text" name="firseName" id="firstName" class="form-control" placeholder="FirstName" required>
                  </div>
              <div class="form-group">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="number" name="contactNo" id="contactNo" class="form-control" placeholder="Contact No" required>
                  </div>
