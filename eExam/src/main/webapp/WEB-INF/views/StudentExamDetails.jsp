...
<head>
<script data-ad-client="ca-pub-4529508631166774" async
						...
						<div class="card-body">
							<div class="table-responsive">
								...
								<form action="saveuserexamans" method="post">
									...
									<c:forEach items="${question}" var="q">
										...
										<fieldset id="group1">
											...
											Option1: <input type="radio" name="userAns<%=i%>"
												value="${q.option1 }"><label id="option1">${q.option1 }</label><br>
											<br> Option2: <input type="radio" name="userAns<%=i%>"
												value="${q.option2 }"><label id="option2">
												${q.option2 }</label><br> <br> Option3: <input
												type="radio" name="userAns<%=i%>" value="${q.option3 }"><label
												id="option3"> ${q.option3 }</label><br> <br>
											Option4: <input type="radio" name="userAns<%=i%>"
												value="${q.option4 }"><label id="option4">
												${q.option4 }</label><br> <br>
										</fieldset>
										<%
										i++;
										%>
									...
									<input type="button" onclick="saveAns()"
										value="Submit Exam Answers" />
								</form>
